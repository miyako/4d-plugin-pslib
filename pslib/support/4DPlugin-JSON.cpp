...
PA_VariableKind ob_get_value_type(PA_ObjectRef obj, const wchar_t *_key) {
    ...
    if(obj)
    {
        ...
        kind = PA_GetObjectPropertyType(obj, &key);
...
bool ob_get_s(PA_ObjectRef obj, const wchar_t *_key, std::string *value) {
